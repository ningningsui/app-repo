pipeline {
    ...
    stages {
		...
		git credentialsId: 'suiningning', url: 'https://github.com/ningningsui/app-repo'
                script {
        ...
        stage('Push Immage') {
            steps {
                ...
                withDockerRegistry(credentialsId: 'ecr:ap-south-1:gitops-jenkins', url: 'https://492666533052.dkr.ecr.ap-south-1.amazonaws.com/gitops-app-demo') {
